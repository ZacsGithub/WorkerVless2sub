...
// 设置优选地址api接口
let addressesapi = [
	'https://raw.githubusercontent.com/ZacsGithub/WorkerVless2sub/main/addressesapi.txt', //可参考内容格式 自行搭建。
	//'https://raw.githubusercontent.com/ZacsGithub/WorkerVless2sub/main/addressesipv6api.txt', //IPv6优选内容格式 自行搭建。
];
...
let DLS = 8;//速度下限
let addressescsv = [
	//'https://raw.githubusercontent.com/ZacsGithub/WorkerVless2sub/main/addressescsv.csv', //iptest测速结果文件。
];

let subconverter = "url.v1.mk"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
let subconfig = "https://raw.githubusercontent.com/ZacsGithub/ACL4SSR/main/Clash/config/ACL4SSR_Online_Full_MultiMode.ini"; //订阅转换配置文件
...
let proxyhostsURL = 'https://raw.githubusercontent.com/ZacsGithub/CFcdnVmess2sub/main/proxyhosts';//在线代理域名池URL
let EndPS = '';//节点名备注内容
let 协议类型 = 'VLESS';
